...
var style_Cheflieu_2 = function(feature, resolution){
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Nom_Provin") !== null) {
        labelText = String(feature.get("Nom_Provin"));
    }
        ...
        image: new ol.style.Circle({radius: 2.09 + size,
            stroke: new ol.style.Stroke({color: 'rgba(255,39,43,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(241,71,45,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
